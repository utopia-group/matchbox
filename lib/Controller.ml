...
module Controller = struct
  ...
  let switch_on (_state : t) (switch_id : Bit.Vector.t) (ports : Bit.Vector.t list) : t =
  ...
  let switch_off (_state : t) (switch_id : Bit.Vector.t) : t = 
  ...
  let link_up (_state : t) (switch : switch) (src : loc) (dst : loc) : t = 
  ...
  let link_down (_state : t) (switch : switch) (src : loc) (dst : loc) : t = 
  ...
  let packet_in (state : t) (switch_id : Bit.Vector.t) (_packet : Bit.Vector.t String.Map.t) : t =
