...
control MyIngress (
  ...
  inout standard_metadata_t standard_metadata)
{
  typedef group_type bit<32>;
  group_type ipv4_group = 0;
  group_type tcp_group  = 0;
  group_type udp_group  = 0;
  group_type icmp_group = 0;

  action setgroup_eth  (group_type g) { eth_group = g;  }
  action setgroup_ipv4 (group_type g) { ipv4_group = g; }
  action setgroup_tcp  (group_type g) { tcp_group = g;  }
  action setgroup_udp  (group_type g) { udp_group = g;  }
  action setgroup_icmp (group_type g) { icmp_group = g; }
